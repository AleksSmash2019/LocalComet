...
export const ru: TranslationMap = {
  ...
  'chat.model_unavailable_detail': 'LocalComet использует локальную модель. У помощника нет доступа к интернету, почте, файлам, Vault, shell, Computer Use и внешним инструментам. Подключите одобренную локальную модель, чтобы начать.',
  ...
  'chat.first_use_detail': 'Сообщения обрабатывает готовая локальная модель в текущей локальной архитектуре. Интернет, почта, файлы, Vault, shell, Computer Use и внешние инструменты недоступны.',
