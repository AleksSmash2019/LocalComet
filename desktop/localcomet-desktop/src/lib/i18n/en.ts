...
export const en: TranslationMap = {
  ...
  'chat.model_unavailable_detail': 'LocalComet uses a local model. The assistant has basic Computer Use and shell access, but no internet or arbitrary file access. Connect an approved local model to begin.',
  ...
  'chat.first_use_detail': 'Messages use the ready local model. Shell and Computer Use integrations are available, but internet or arbitrary system file access remains restricted for safety.',
  'chat.local_only_status': 'Secure local conversation',
  ...
  'approval.no_pending': 'No pending approvals',
  'approval.tool': 'Tool',
  'approval.risk': 'Risk',
  'approval.target': 'Target',
  'approval.side_effects': 'Side effects',
  'approval.expires': 'Expires',
  'approval.target_unknown': 'Unknown target',
  'approval.risk_unknown': 'Unknown risk',
  'approval.expiry_unknown': 'Unknown expiry',
  'approval.side_effects_unknown': 'Unknown side effects',
  'approval.risk_read_only': 'Read only',
  'approval.risk_guarded': 'Guarded',
  'approval.risk_dangerous': 'Dangerous',
  'approval.side_effects.artifact_download': 'Downloads a local artifact',
  'approval.side_effects.artifact_remove': 'Removes a local artifact',
  'approval.side_effects.runtime_start': 'Starts a managed runtime',
  'approval.side_effects.runtime_stop': 'Stops a managed runtime',
  'approval.side_effects.model_binding_set': 'Updates model binding',
  ...
  'settings.project_context_unavailable': 'Project context is currently unavailable.',
  
  // Permissions
  'permissions.title': 'Permissions',
  'permissions.desc': 'Control what the AI is allowed to do on your computer.',
  'permissions.files': 'File System Access',
  'permissions.files_desc': 'Allow reading and writing files in authorized directories.',
  'permissions.shell': 'Execute Commands',
  'permissions.shell_desc': 'Allow running shell commands and scripts.',
  'permissions.tools': 'External Tools',
  ...
  'models.managed_model': 'Selected model',
  ...
  'models.connecting': 'Validating and connecting the local model',
  'models.bytes': 'bytes',
  ...
  'models.download_error': 'The model download could not finish. Review the source and retry.',
  ...
  'models.remove_confirm_detail': 'This removes only the selected managed model. Chats, settings, the runtime, and your own files are not removed.',
  ...
  'models.approved_catalog': 'Approved catalog',
  'models.approved_catalog_title': 'All available models',
  'models.approved_catalog_count': 'entries',
  'models.approved_catalog_empty': 'No approved models yet',
  ...
  'models.custom_invalid': 'This custom model failed validation. Re-import it from its canonical URL or remove it.',
  'models.custom_empty': 'No user-supplied models imported',
  ...
  // HF Browser
  'nav.hf_browser': 'HF Models',
  'hf.title': 'Hugging Face Model Browser',
  'hf.subtitle': 'Find and download GGUF models for local inference',
  ...
  'hf.no_gguf': 'No .gguf files in this repository',
  'hf.filename': 'File',
  'hf.quant': 'Quantization',
  'hf.size': 'Size',
