...
export const en: TranslationMap = {
  ...
  'chat.model_unavailable_detail': 'LocalComet uses a local model. This assistant has no internet, email, file, Vault, shell, Computer Use, or external-tool access. Connect the approved local model to begin.',
  ...
  'chat.first_use_detail': 'Messages use the ready local model and remain within the current local architecture. No internet, email, files, Vault, shell, Computer Use, or external tools are available.',
